...
COPY . /aline-transaction-microservice

# package up microservice
WORKDIR /aline-transaction-microservice/
RUN mvn -Dmaven.test.skip package

# Run Microservice
WORKDIR /aline-transaction-microservice/transaction-microservice/
CMD java -jar /aline-transaction-microservice/transaction-microservice/target/transaction-microservice-0.1.0.jar